...
\begin{thebibliography}{1}
	...
	\bibitem{unity_shader} \textsc{Unity} \url{https://unity3d.com/learn/tutorials/topics/graphics/gentle-introduction-shaders} (Hozzáférés ideje: 2019.03.28)
	\bibitem{youtube_shader} \textsc{Youtube} \url{https://www.youtube.com/watch?v=KGGB5LFEejg&t=182s} (Hozzáférés ideje: 2019.03.28)
\end{thebibliography}
\end{document}
